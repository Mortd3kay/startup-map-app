...
@Database(entities = [Tag::class, Message::class, Chat::class, User::class, UserTags::class, Role::class, Project::class, ProjectRoles::class, ProjectTags::class, ProjectUser::class,ProjectAndRole::class], version = 7, exportSchema = false)
